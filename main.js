...
$(function() {
  ...
  function set_settings() {
    ...
    settings.defaultredirect = 'https://fandm.co1.qualtrics.com/jfe/form/SV_2nNuK3rkiqEb3cq';
    ...
    settings.condition_1_likes = [22000, 9999999]; 
    ...
    settings.condition_2_likes = [20000, 25000,35000,80000,1320000,150000];  
    ...
    settings.condition_3_likes = [120000, 21000,25000,35000,80000,100000,110000,150000,20000]; 
	...
	settings.condition_1_adjusted_likes = [22000, 24000,25000,35000,80000,100000,110000,150000,20000]; // 9
	settings.condition_2_adjusted_likes = [22000, 24000,25000,35000,80000]; // 5
	settings.condition_3_adjusted_likes = [22000, 9999999]; //1	
    ...
    settings.likes_by = ['John','Jennifer','Sarah','Noah','Beth','James','Nick','Heather','Kim']; 
  }
